...
export const Lost = () => {
    ...
    const openImage = (image, description) => {
    ...
    return (
        <>
            <div className='flex items-center justify-center'>
                <h1 className='ml-72 mt-[100px] mb-10 text-2xl font-poppins text-blue-600 font-semibold'>Displaying Lost Items at BIT Campus</h1>
            </div>
                                ...
                                <tr key={item.id} className="border-t text-center">
                                    ...
                                    <td className="py-2">
                                        <button
                                            ...
                                            onClick={() => openImage(item.url, item.description || 'No description available')}
                                        >
                                            View
                                        </button>
                                    </td>
