...
export const ClaimItem = () => {
    ...
    const fetchLostItem = async () => {
        try {
            const docRef = doc(db, 'foundItems', itemId);
    ...
    const fetchReporterDetails = async (reporterId) => {
        const [firstName, lastName] = reporterId.split(" ");
    ...
    return (
        <div className="ml-80 container mx-auto mt-10 px-4">
            <h1 className="text-3xl font-bold text-center text-red-600 mb-8">Claim Item</h1>
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-1 bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-200">
                    ...
                    <p className="text-gray-800 text-base mb-2"><strong>Date Found:</strong> {lostItem.dateFound}</p>
                    <p className="text-gray-800 text-base mb-2"><strong>Time Found:</strong> {lostItem.timeFound}</p>
